...
| `calfont` | `scr`, `cal` | `scr` | police des familles nommées : `\mathscr` ou `\mathcal` |

Par exemple, `\usepackage[setfont=rm, calfont=cal]{ocots}` compose `\R` en
`\mathrm{R}` et les macros de familles en `\mathcal`.
